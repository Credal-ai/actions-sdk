...
export const slackUserSearchSlackDefinition: ActionTemplate = {
  ...
  output: {
    ...
    properties: {
      ...
      results: {
        type: "array",
        description: "Array of standardized result objects",
        items: {
          type: "object",
          required: ["external_resource_id", "name", "url", "content"],
          properties: {
            ...
            url: {
              type: "string",
              description: "Slack permalink to the message or thread",
            },
            content: {
              type: "string",
              description: "JSON string containing message text, context, author info, and thread details",
            },
          },
        },
      },
...
export const jiraGetJiraTicketDetailsDefinition: ActionTemplate = {
  ...
  output: {
    ...
    properties: {
      success: {
        type: "boolean",
        description: "Whether the ticket details were retrieved successfully",
      },
      results: {
        type: "array",
        description: "Array of standardized result objects",
        items: {
          ...
          properties: {
            external_resource_id: {
              type: "string",
              description: "The Jira ticket key or ID",
            },
            name: {
              type: "string",
              description: "The ticket summary or title",
            },
            url: {
              type: "string",
              description: "Web URL to access the ticket in Jira",
            },
            content: {
              type: "string",
              description: "JSON string containing all ticket data including description, status, assignee, and fields",
            },
          },
        },
      },
      ...
      results: {
        ...
        items: {
          ...
          properties: {
            external_resource_id: {
              type: "string",
              description: "The Jira issue key (e.g. SSPR-123)",
            },
            name: {
              type: "string",
            ...
            url: {
              type: "string",
              description: "Web URL to access the issue in Jira",
            },
            content: {
              type: "string",
              description:
      ...
      results: {
        ...
        items: {
          ...
          properties: {
            ...
            name: {
              type: "string",
              description: "The page title or URL",
            },
            url: {
              type: "string",
            ...
            content: {
              type: "string",
              description: "The scraped content from the URL",
            },
          },
        },
      },
      ...
      results: {
        ...
        items: {
          ...
          properties: {
            ...
            url: {
              type: "string",
              description: "The web link to view the file in Google Drive",
            },
            content: {
              type: "string",
              description: "The file content and metadata as JSON string",
            },
          },
        },
      },
      ...
      results: {
        ...
        items: {
          ...
          properties: {
            ...
            name: {
              type: "string",
              description: "The user's display name or email",
            },
            url: {
              type: "string",
              description: "Web URL to access the user profile in Okta",
            },
            content: {
              type: "string",
              description: "JSON string containing all user details and attributes",
            },
          },
        },
      },
      ...
      results: {
        ...
        items: {
          ...
          properties: {
            ...
            name: {
              type: "string",
              description: "Display name or title of the record",
            },
            url: {
              type: "string",
              description: "Web URL to access the record in Salesforce",
            },
            content: {
              type: "string",
              description: "JSON string containing all record data and fields",
            },
          },
        },
      },
        ...
        items: {
          ...
          properties: {
            ...
            content: {
              type: "string",
              description:
                "JSON string containing pull request details including state, description, author, and timestamps",
            },
          },
        },
      },
      ...
      results: {
        ...
        items: {
          ...
          properties: {
            external_resource_id: {
              type: "string",
              description: "The file path or SHA",
            },
            name: {
              type: "string",
              description: "The name of the file",
            ...
            content: {
              type: "string",
              description: "The decoded file content and metadata as JSON string",
            },
          },
        },
      },
      ...
      results: {
        ...
        items: {
          ...
          properties: {
            ...
            content: {
              type: "string",
              description: "JSON string containing file metadata including type, size, and path",
            },
          },
        },
      },
      ...
      results: {
        ...
        items: {
          ...
          properties: {
            external_resource_id: {
              type: "string",
              description: "The SHA, issue number, or file path",
            },
            name: {
              type: "string",
              description: "The filename, commit message, or issue/PR title",
            },
            url: {
              type: "string",
              description: "Web URL to access the resource in GitHub",
            },
            content: {
              type: "string",
              description: "JSON string containing all search result data including matches, scores, and metadata",
            },
          },
        },
      },
      ...
      results: {
        ...
        items: {
          ...
          properties: {
            external_resource_id: {
              type: "string",
              description: "The ID of the merge request, blob, or commit",
            },
            name: {
              type: "string",
              description: "Title of merge request, filename of blob, or commit message",
            },
            url: {
              type: "string",
              description: "Web URL to access the resource in GitLab",
            },
            content: {
              type: "string",
              description: "JSON string containing all resource data including diffs and metadata",
            },
          },
        },
      },
      ...
      results: {
        ...
        items: {
          ...
          properties: {
            external_resource_id: {
              type: "string",
              description: "The file path or commit SHA",
            },
            name: {
              type: "string",
              description: "The name of the file",
