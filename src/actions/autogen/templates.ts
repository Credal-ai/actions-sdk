...
export const jiraCommentJiraTicketWithMentionsDefinition: ActionTemplate = {
        ...
        "description": "Comments on a Jira ticket, converting [~accountid:ID] patterns into clickable @mentions. On Jira Cloud, mentions render as clickable user tags. On Data Center, the comment is posted as plain text (mention conversion is not applicable).",
        "scopes": [
            "write:comment:jira"
        ],
        "tags": [],
