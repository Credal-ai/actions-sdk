        ...
        "parameters": {
            ...
            "properties": {
                ...
                "taskDateTimeTieBreakerField": {
                    "type": "string",
                    "description": "Task only — optional Task Date/Time field API name used after ActivityDate to order same-day synced email Tasks. This is intended for Groove-style fields such as groove_email_sent_at__c. The field API name must match [A-Za-z_][A-Za-z0-9_]* — names failing this check are rejected immediately. Unrecognized but syntactically valid field names produce a Salesforce API error at query time."
                }
            }
        },
        "output": {
            ...
            "properties": {
                ...
                "threads": {
                    "type": "array",
                    "description": "Deduplicated email threads. EmailMessage threads include a parentId field: for Email to Case records this is the Case ID (the definitive support thread container); for Enhanced Email (Gmail/Outlook connector) records it is the auto-generated Task ID.",
                    "items": {
                        "type": "object",
                        "additionalProperties": true
                    }
                ...
                "activityIds": {
                    "type": "string",
                    "description": "EmailMessage only, returnActivityIds=true — JSON array string of Task IDs auto-generated alongside matching EmailMessage records. Covers up to 10,000 ActivityIds (5 Salesforce query pages). Sufficient for typical agent context; orgs with higher volumes require a narrower whereClause."
                },
                "hasMore": {
                    "type": "boolean",
