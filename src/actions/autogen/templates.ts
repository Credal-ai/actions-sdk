...
export const linearCreateIssueDefinition: ActionTemplate = {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "approved": {
                    "type": "boolean",
                    "description": "Set to true to confirm and execute the issue creation after reviewing the pendingAction details"
                }
            }
        },
        "output": {
            ...
            "properties": {
                ...
                "requiresApproval": {
                    "type": "boolean",
                    "description": "True when the action is awaiting human approval before executing"
                },
                "pendingAction": {
                    "type": "object",
                    "description": "Details of the action pending human approval",
                    "properties": {
                        "actionName": {
                            "type": "string",
                            "description": "The name of the action awaiting approval"
                        },
                        "provider": {
                            "type": "string",
                            "description": "The provider of the action awaiting approval"
                        },
                        "params": {
                            "type": "object",
                            "description": "The parameters of the action awaiting approval"
                        }
                    }
                }
            }
...
export const linearCommentOnIssueDefinition: ActionTemplate = {
        "displayName": "Comment on a Linear issue",
        "description": "Post a comment on an existing Linear issue. Requires human approval before posting.",
        "scopes": [],
        "tags": [],
        "parameters": {
            "type": "object",
            ...
            "properties": {
                "issueId": {
                    "type": "string",
                    "description": "The ID of the Linear issue to comment on"
                },
                "body": {
                    "type": "string",
                ...
                "approved": {
                    "type": "boolean",
                    "description": "Set to true to confirm and post the comment after reviewing the pendingAction details"
                }
            }
        },
        "output": {
