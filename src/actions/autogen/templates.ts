...
export const googleOauthReadCommentsOnDocDefinition: ActionTemplate = {
  ...
  description: "List comments (and replies) on a Google Doc using the Google Drive API",
  ...
  parameters: {
    ...
    properties: {
      documentId: {
        type: "string",
        description: "The ID of the Google Doc to read comments from",
        tags: ["recommend-predefined"],
      },
      pageSize: {
        type: "number",
        description: "The maximum number of comments to return in a single page",
      },
      includeDeleted: {
        type: "boolean",
  ...
  output: {
    ...
    properties: {
      success: {
        type: "boolean",
        description: "Whether the comments were retrieved successfully",
      },
      comments: {
        type: "array",
        ...
        items: {
          ...
          properties: {
            ...
            quotedFileContent: {
              type: "object",
              description: "Content quoted from the file, if present",
              properties: {
                value: {
                  type: "string",
