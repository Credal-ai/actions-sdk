...
export const snowflakeRunSnowflakeQueryWriteResultsToS3Definition: ActionTemplate = {
  ...
  parameters: {
    type: "object",
    required: ["databaseName", "warehouse", "query", "user", "accountName", "s3BucketName", "s3ObjectKey"],
    properties: {
      databaseName: {
        type: "string",
        description: "The name of the database to query",
      ...
      s3ObjectKey: {
        type: "string",
        description: "The key/path where the results will be stored in the S3 bucket",
      },
      s3Region: {
        type: "string",
        description: "The AWS region where the S3 bucket is located (defaults to us-east-1)",
      },
      outputFormat: {
        type: "string",
