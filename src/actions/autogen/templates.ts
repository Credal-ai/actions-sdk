...
export const zendeskListTicketsByQueryDefinition: ActionTemplate = {
        "description": "List tickets in Zendesk by search query with flexible filtering options",
        "scopes": [],
        "parameters": {
            "type": "object",
            "required": [
