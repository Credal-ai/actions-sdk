...
export const jiraGetJiraIssuesByQueryDefinition: ActionTemplate = {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "startAt": {
                    "type": "number",
                    "description": "Offset of the first result to return. Use itemsReturned from the previous response as the next startAt value to page through results. Defaults to 0."
                }
            }
        },
        "output": {
            ...
            "properties": {
                "itemsReturned": {
                    "type": "number",
                    "description": "Number of items returned in this response. Use this value as startAt in the next call to continue pagination. Appears before results so it is readable even if the results are truncated."
                },
                "truncated": {
                    "type": "boolean",
                    "description": "True when more results exist beyond this batch. Call again with startAt incremented by itemsReturned to retrieve the next page."
                },
                "results": {
                    "type": "array",
