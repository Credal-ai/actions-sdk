...
export const confluenceFetchPageContentOutputSchema = z.object({ "pageId": z.string().describe("The ID of the page"), "title": z.string().describe("The title of the page"), "content": z.string().describe("The content of the page in storage format (HTML)"), "pageUrl": z.string().describe("The URL to access the page") });
