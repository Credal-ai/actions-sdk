...
export const jiraCommentJiraTicketParamsSchema = z.object({ "projectKey": z.string().describe("The key for the project you want to add it to"), "issueId": z.string().describe("The issue ID associated with the ticket to be commented on"), "comment": z.string().describe("The text to be commented on the ticket") });
...
export const salesforceGetSalesforceRecordsByQueryParamsSchema = z.object({ "query": z.string().describe("The SOQL query to execute") });
