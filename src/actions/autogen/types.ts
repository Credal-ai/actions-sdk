...
export const slackUserSearchSlackOutputSchema = z.object({
  ...
  results: z
    .array(
      z.object({
        external_resource_id: z.string().describe("The Slack message timestamp"),
        name: z.string().describe("The channel name or user name"),
        url: z.string().describe("Slack permalink to the message or thread"),
        content: z.string().describe("JSON string containing message text, context, author info, and thread details"),
      }),
    )
    .describe("Array of standardized result objects"),
...
export const jiraGetJiraTicketDetailsOutputSchema = z.object({
  success: z.boolean().describe("Whether the ticket details were retrieved successfully"),
  results: z
    .array(
      z.object({
        external_resource_id: z.string().describe("The Jira ticket key or ID"),
        name: z.string().describe("The ticket summary or title"),
        url: z.string().describe("Web URL to access the ticket in Jira"),
        content: z
          .string()
          .describe("JSON string containing all ticket data including description, status, assignee, and fields"),
      }),
    )
    .describe("Array of standardized result objects"),
...
export const jiraGetJiraIssuesByQueryOutputSchema = z.object({
  ...
  results: z
    .array(
      z.object({
        external_resource_id: z.string().describe("The Jira issue key (e.g. SSPR-123)"),
        name: z.string().describe("The issue summary or title"),
        url: z.string().describe("Web URL to access the issue in Jira"),
        content: z
          .string()
          .describe(
            "JSON string containing all issue data including description, status, assignee, project, and timestamps",
          ),
      }),
    )
    .describe("Array of standardized result objects"),
...
export const firecrawlScrapeUrlOutputSchema = z.object({
  ...
  results: z
    .array(
      z.object({
        external_resource_id: z.string().describe("The URL that was scraped"),
        name: z.string().describe("The page title or URL"),
        url: z.string().describe("The original URL that was scraped"),
        content: z.string().describe("The scraped content from the URL"),
      }),
    )
    .describe("Array of standardized result objects"),
  error: z.string().describe("Error message if scraping failed").optional(),
});
...
export const googleOauthSearchDriveByKeywordsAndGetFileContentOutputSchema = z.object({
  ...
  results: z
    .array(
      z.object({
        external_resource_id: z.string().describe("The Google Drive file ID"),
        name: z.string().describe("The file name"),
        url: z.string().describe("The web link to view the file in Google Drive"),
        content: z.string().describe("The file content and metadata as JSON string"),
      }),
    )
    .describe("Array of standardized result objects"),
  error: z.string().describe("Error message if search failed").optional(),
...
export const oktaOrgGetOktaUserByNameOutputSchema = z.object({
  ...
  results: z
    .array(
      z.object({
        external_resource_id: z.string().describe("The user's Okta ID"),
        name: z.string().describe("The user's display name or email"),
        url: z.string().describe("Web URL to access the user profile in Okta"),
        content: z.string().describe("JSON string containing all user details and attributes"),
      }),
    )
    .describe("Array of standardized result objects"),
  error: z.string().describe("Error message if retrieval failed.").optional(),
...
export const salesforceSearchSalesforceRecordsOutputSchema = z.object({
  ...
  results: z
    .array(
      z.object({
        external_resource_id: z.string().describe("The Salesforce record ID"),
        name: z.string().describe("Display name or title of the record"),
        url: z.string().describe("Web URL to access the record in Salesforce"),
        content: z.string().describe("JSON string containing all record data and fields"),
      }),
    )
    .describe("Array of standardized result objects"),
  error: z.string().describe("The error that occurred if the records were not successfully retrieved").optional(),
...
export const githubListPullRequestsOutputSchema = z.object({
  ...
  results: z
    .array(
      z.object({
        external_resource_id: z.string().describe("The pull request number"),
        name: z.string().describe("The title of the pull request"),
        url: z.string().describe("The URL of the pull request"),
        content: z
          .string()
          .describe("JSON string containing pull request details including state, description, author, and timestamps"),
      }),
    )
    .describe("Array of standardized result objects"),
  error: z.string().describe("Error message if the operation failed").optional(),
...
export const githubGetFileContentOutputSchema = z.object({
  ...
  results: z
    .array(
      z.object({
        external_resource_id: z.string().describe("The file path or SHA"),
        name: z.string().describe("The name of the file"),
        url: z.string().describe("The URL of the file in the GitHub UI"),
        content: z.string().describe("The decoded file content and metadata as JSON string"),
      }),
    )
    .describe("Array of standardized result objects"),
  error: z.string().describe("The error that occurred if the operation was not successful").optional(),
...
export const githubListDirectoryOutputSchema = z.object({
  ...
  results: z
    .array(
      z.object({
        external_resource_id: z.string().describe("The path of the file or directory"),
        name: z.string().describe("The name of the file or directory"),
        url: z.string().describe("The URL of the file in the GitHub UI"),
        content: z.string().describe("JSON string containing file metadata including type, size, and path"),
      }),
    )
    .describe("Array of standardized result objects"),
  error: z.string().describe("Error message if the operation failed").optional(),
...
export const githubSearchOrganizationOutputSchema = z.object({
  ...
  results: z
    .array(
      z.object({
        external_resource_id: z.string().describe("The SHA, issue number, or file path"),
        name: z.string().describe("The filename, commit message, or issue/PR title"),
        url: z.string().describe("Web URL to access the resource in GitHub"),
        content: z
          .string()
          .describe("JSON string containing all search result data including matches, scores, and metadata"),
      }),
    )
    .describe("Array of standardized result objects"),
  error: z.string().describe("Error message if the search failed").optional(),
...
export const gitlabSearchGroupOutputSchema = z.object({
  ...
  results: z
    .array(
      z.object({
        external_resource_id: z.string().describe("The ID of the merge request, blob, or commit"),
        name: z.string().describe("Title of merge request, filename of blob, or commit message"),
        url: z.string().describe("Web URL to access the resource in GitLab"),
        content: z.string().describe("JSON string containing all resource data including diffs and metadata"),
      }),
    )
    .describe("Array of standardized result objects"),
  error: z.string().describe("Error message if the search failed").optional(),
...
export const gitlabGetFileContentOutputSchema = z.object({
  ...
  results: z
    .array(
      z.object({
        external_resource_id: z.string().describe("The file path or commit SHA"),
        name: z.string().describe("The name of the file"),
        url: z.string().describe("The URL of the file in the GitLab UI"),
        content: z.string().describe("The decoded file content and metadata as JSON string"),
      }),
    )
    .describe("Array of standardized result objects"),
  ...
  results: z
    .array(
      z.object({
        external_resource_id: z.string().describe("The path of the file or directory"),
        name: z.string().describe("The name of the file or directory"),
        url: z.string().describe("The URL of the file or folder in the GitLab UI"),
        content: z.string().describe("JSON string containing file metadata including type, size, and path"),
      }),
    )
    .describe("Array of standardized result objects"),
