...
export const snowflakeRunSnowflakeQueryWriteResultsToS3ParamsSchema = z.object({ "databaseName": z.string().describe("The name of the database to query"), "warehouse": z.string().describe("The warehouse to use for executing the query"), "query": z.string().describe("The SQL query to execute"), "user": z.string().describe("The username to authenticate with"), "accountName": z.string().describe("The name of the Snowflake account"), "s3BucketName": z.string().describe("The name of the S3 bucket to write results to"), "s3Region": z.string().describe("The AWS region where the S3 bucket is located"), "outputFormat": z.enum(["json","csv"]).describe("Format for the output file (json or csv, defaults to json)").optional() });
...
export const snowflakeRunSnowflakeQueryWriteResultsToS3OutputSchema = z.object({ "bucketUrl": z.string().describe("The URL of the S3 bucket where the results are stored"), "message": z.string().describe("A message describing the result or error"), "rowCount": z.number().describe("The number of rows returned by the query") });
