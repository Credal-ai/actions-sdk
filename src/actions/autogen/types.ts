...
export const workdayRequestTimeOffParamsSchema = z.object({ "userEmail": z.string().describe("The email of the employee requesting time off"), "startDate": z.string().describe("The start date of the time off request"), "endDate": z.string().describe("The end date of the time off request"), "timeOffType": z.string().describe("The type of time off being requested") });
