...
export const workdayRequestTimeOffParamsSchema = z.object({ "workerId": z.string().describe("The worker/employee ID of the person requesting time off"), "startDate": z.string().describe("The start date of the time off request"), "endDate": z.string().describe("The end date of the time off request"), "timeOffType": z.string().describe("The type of time off being requested"), "tenantName": z.string().describe("The name of the Workday tenant") });

export type workdayRequestTimeOffParamsType = z.infer<typeof workdayRequestTimeOffParamsSchema>;

export const workdayRequestTimeOffOutputSchema = z.object({ "requestId": z.string().describe("The ID of the time off request") });

export type workdayRequestTimeOffOutputType = z.infer<typeof workdayRequestTimeOffOutputSchema>;
export type workdayRequestTimeOffFunction = ActionFunction<workdayRequestTimeOffParamsType, AuthParamsType, workdayRequestTimeOffOutputType>;
...
export const jiraCreateJiraTicketParamsSchema = z.object({ "projectKey": z.string().describe("The key for the project you want to add it to"), "summary": z.string().describe("The summary of the new ticket"), "description": z.string().describe("The description for the new ticket"), "issueType": z.string().describe("The issue type of the new ticket"), "reporter": z.string().describe("The reporter for the new ticket creation").optional(), "assignee": z.string().describe("The assignee for the new ticket creation").optional(), "username": z.string().describe("The username of the person creating the ticket") });
