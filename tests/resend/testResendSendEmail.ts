...
async function runTest() {
  ...
  console.log("Test 1: Sending email to single recipient...");
  ...
  assert(
    result1.success,
    "Email to single recipient was not sent successfully"
  );
  ...
  assert(
    result2.success,
    "Email to multiple recipients was not sent successfully"
  );
