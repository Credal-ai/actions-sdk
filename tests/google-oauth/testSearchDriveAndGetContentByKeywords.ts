import type { googleOauthSearchDriveAndGetContentByKeywordsParamsType } from "../../src/actions/autogen/types.js";
...
async function runTest() {
  ...
  const result = await runAction(
    ...
    },
    {
      ...
      fileLimit: 5,
      fileSizeLimit: 200,
    } as googleOauthSearchDriveAndGetContentByKeywordsParamsType,
  );
