...
const scope =
  "offline_access ChatMessage.Send ChannelMessage.Send Files.ReadWrite Sites.ReadWrite.All Files.Read.All Sites.Read.All"; // offline_access ensures refresh token is returned
